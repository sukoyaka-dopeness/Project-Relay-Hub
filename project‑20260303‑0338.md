# project-20260303-0338.md

============================================================
= 1. SESSION_LOG（このセッションで実際に行った作業のみ） =
============================================================

- 作業1: 「完全版内容ファイルを生成してください。」
- 作業2: Perplexity-session1.md（完全版内容ファイル）の生成
...
===========================================
= 2. RELAY_DOCUMENT_COMPRESSED（圧縮記法） =
===========================================

#SESSION
[AI=Perplexity|WHY=初回セッションのため前回状態なし]

#OUTPUT
[FILE=Perplexity-session1.md|WHY=ユーザー依頼に基づく完全版内容ファイル生成]

#STRUCTURE
[LAYERS=SESSION_LOG;COMPRESSED;SAMPLES|WHY=HANDOFF_TEMPLATE準拠]

#STATE
[PREVIOUS_SESSION=none|WHY=初回]
[UPDATED_COMPRESSED=none|WHY=更新なし]
[UPDATED_SAMPLES=none|WHY=更新なし]


===========================================
= 3. RELAY_DOCUMENT_SAMPLES（原文保存） =
===========================================

## 生成物：Perplexity-session1.md（全文）
